...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    justify_format(root, 'commit_data', commit_data, 50)
    justify_format(root, 'star_data', star_data, 52)
    justify_format(root, 'repo_data', repo_data, 52)
    justify_format(root, 'contrib_data', contrib_data, 46)
    justify_format(root, 'follower_data', follower_data, 48)
    justify_format(root, 'loc_data', loc_data[2], 48)
    justify_format(root, 'loc_add', loc_data[0], 48)
    justify_format(root, 'loc_del', loc_data[1], 46)
    tree.write(filename, encoding='utf-8', xml_declaration=True)


def justify_format(root, element_id, new_text, length=0):
    """
    Updates the text of the element by ID and dynamically calculates dot spacing to maintain a perfectly justified right margin.
    """
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2006, 6, 15))
